...
from .views import ( ChangeProfilePictureView, LoginView, RequestMembershipView,ResetPasswordView,Admin_all_generalinformation, add_user_info,  download_single_user_info, logout_view, user_list,family_list,announcement_list,
